...
export const MainProvider = ({ children }: { children: ReactNode }) => {
  ...
  return <MainContext.Provider value={{ showNavigation, setShowNavigation, showCartSection, setShowCartSection, db, setDb, cartItems, setCartItems }}>{children}</MainContext.Provider>;
};
